...
public class ProductServiceImpl implements ProductService {
   ...
   /**
    * @see org.deepintojee.poc.rest.domain.services.ProductService#list()
    */
   @Override
   ...
   /**
    * @see org.deepintojee.poc.rest.domain.services.ProductService#findByDescription(java.lang.String)
    */
   @Override
   ...
   /**
    * @see org.deepintojee.poc.rest.domain.services.ProductService#add(org.deepintojee.poc.rest.domain.Product)
    */
   @Override
   ...
   /**
    * @see org.deepintojee.poc.rest.domain.services.ProductService#update(org.deepintojee.poc.rest.domain.Product)
    */
   @Override
   ...
   /**
    * @see org.deepintojee.poc.rest.domain.services.ProductService#get(java.lang.Long)
    */
   @Override
   ...
   /**
    * @see org.deepintojee.poc.rest.domain.services.ProductService#delete(java.lang.Long)
    */
   @Override
   ...
   /**
    * @see org.deepintojee.poc.rest.domain.services.ProductService#clear()
    */
   @Override
   public void clear() {
